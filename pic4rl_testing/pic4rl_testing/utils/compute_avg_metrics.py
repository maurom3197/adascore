...
class Compute_Metrics():
    def __init__(self):
        ...
        self.metrics_results = {"Clearance_time":None, 
                ...
                "Cumulative_social_work":None,
                "Max_social_work":None,
                "Mean_social_work":None, 
    ...
    def copy_metrics(self,):
        ...
        for i in range(num_exp):
            ...
            results['Mean_social_work'] = results['Mean_social_work, Std_dev_social_work'][0]
            results['Std_dev_social_work'] = results['Mean_social_work, Std_dev_social_work'][1]
            results['Max_social_work'] = results['Max_social_work, Min_social_work'][0]
