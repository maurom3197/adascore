...
from pic4rl_testing.pic4rl_environment_social_controller import Pic4rlEnvironmentAPPLR
...
class Pic4rlTesting_APPLR_social_controller(Pic4rlEnvironmentAPPLR):
    def __init__(self):
        super().__init__()
        #rclpy.logging.set_logger_level('pic4rl_testing', 10)
        self.log_check()
        ...
        if self.tflite_flag:
            ...
            self.set_parser_list(training_params)
    ...
    def set_parser_list(self, training_params):
        self.parser_list = []
    ...
    def threadFunc(self):
        try:
            ...
            self.get_logger().error("Error in starting tester: {}".format(e))
            return
    ...
    def parameters_declaration(self):
        ...
        return main_params, train_params