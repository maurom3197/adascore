...
def generate_launch_description():
    ...
    params_file             = os.path.join(pic4nav_config, 'social_nav_params_with_map.yaml')
    ...
    #default_bt_xml_filename = LaunchConfiguration('default_bt_xml_filename', default_bt_xml_filename)
