...
from adascore.tasks.SocialController.adascore_environment_social_controller import Pic4rlEnvironmentAdascore
from ament_index_python.packages import get_package_share_directory

class SocialControllerAdascore(Pic4rlEnvironmentAdascore):
    def __init__(self):
        super().__init__()
