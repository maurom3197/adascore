...
from applr_social_nav.tasks.SocialForceWindowReal.applr_environment_social_cotroller import (
    Pic4rlEnvironmentAPPLR,
)
from ament_index_python.packages import get_package_share_directory


class SocialForceWindowAPPLR(Pic4rlEnvironmentAPPLR):
    def __init__(self):
        super().__init__()
        self.log_check()
