...
from applr_social_nav.tasks.SocialControllerCostmap.applr_environment_social_controller import Pic4rlEnvironmentAPPLR
from ament_index_python.packages import get_package_share_directory

class SocialControllerCostmapAPPLR(Pic4rlEnvironmentAPPLR):
    def __init__(self):
        super().__init__()
